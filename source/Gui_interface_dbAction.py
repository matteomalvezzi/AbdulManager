...
def correct_authentication(window, socket_client):
    ...
    new_window.config(background="#5a5050")
    ...
    label_title = Label(frame_work,
                        text="Ufficio risorse umane", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050", )
    label_title.grid(row=0, columnspan=3, pady=6, padx=6)

    pul_1 = Button(frame_work, text="Create", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
    ...
    pul_2 = Button(frame_work, text="Read", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
                   command=read_db,
    ...
    pul_3 = Button(frame_work, text="Update", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
                   command=update,
    ...
    pul_4 = Button(frame_work, text="Delete", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
                   command=delete,
    ...
    pul_5 = Button(frame_work, text="Add Impiegi", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
    ...
    pul_6 = Button(frame_work, text="Add Sedi", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
                   command=add_Sedi,
    ...
    pul_7 = Button(frame_work, text="Add Reparti", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
                   command=add_Reparti,
    ...
    pul_8 = Button(frame_work, text="Get All dipendenti", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                   activeforeground="white",
                   activebackground="#5a5050",
                   pady=10,
...
def create():  # add someone to the db
    ...
    def actionListener_Sedi(event):
        ...
        # --------------------Reparti-------------------------------
        label_occupation = Label(frame_work, text="Reparti:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                                 bg="#5a5050", )
    ...
    Window_create.config(background="#5a5050")

    frame_work = Frame(Window_create, bg="#5a5050", )
    frame_work.pack(pady=75)

    label_title = Label(frame_work, text="Aggiungi Persone", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=5, pady=6, padx=3)

    # ------------------------NAME---------------------------
    label_name = Label(frame_work, text="Nome:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_name.grid(row=1, column=0, pady=6, padx=3, sticky=W)

    entry_name = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_name.grid(row=1, column=1)
    # -----------------------------------------------------------
    # --------------------SURENAME---------------------------
    label_surename = Label(frame_work, text="Cognome:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_surename.grid(row=2, column=0, pady=6, padx=3, sticky=W)

    entry_surename = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_surename.grid(row=2, column=1)
    # -----------------------------------------------------------
    # ---------------------------GENDER--------------------------
    label_gender = Label(frame_work, text="Sesso:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_gender.grid(row=3, column=0, pady=6, padx=3, sticky=W)

    G = ["M", "F"]
    val = IntVar()
    for i in range(len(G)):
        radio_gender = Radiobutton(frame_work, text=G[i], value=i, variable=val, bg="#5a5050", activeforeground="white",
                                   activebackground="#5a5050", command=get_gender)
        if i == 0:
    ...
    # -----------------------------------------------------------
    # -------------------------Birth DATE------------------------------
    label_date = Label(frame_work, text="Data di nascita:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                       bg="#5a5050", )
    label_date.grid(row=4, column=0, pady=6, padx=3, sticky=W)

    entry_dataNascita = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_dataNascita.insert(0,"0000-00-00")
    entry_dataNascita.grid(row=4, column=1)
    # -----------------------------------------------------------
    # --------------------Birth place-----------------------------
    label_occupation = Label(frame_work, text="Luogo di nascita:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                             bg="#5a5050", )
    label_occupation.grid(row=5, column=0, pady=6, padx=3, sticky=W)

    entry_luogoNascita = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_luogoNascita.grid(row=5, column=1)
    # -----------------------------------------------------------
    # -------------------Codice Fiscale-----------------------------
    label_occupation = Label(frame_work, text="Codice Fiscale:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                             bg="#5a5050", )
    label_occupation.grid(row=1, column=2, pady=6, padx=3, sticky=W)

    entry_fiscale = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_fiscale.grid(row=1, column=3)
    # -----------------------------------------------------------
    # --------------------OCCUPATION-----------------------------
    label_occupation = Label(frame_work, text="Impiego:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                             bg="#5a5050", )
    ...
    # -----------------------------------------------------------
    # -------------------------DATE------------------------------
    label_date = Label(frame_work, text="Data di assunzione:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                       bg="#5a5050", )
    label_date.grid(row=3, column=2, pady=6, padx=3, sticky=W)

    entry_dateAssunzione = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_dateAssunzione.insert(0,"0000-00-00")
    entry_dateAssunzione.grid(row=3, column=3)
    # -----------------------------------------------------------

    # ----------------------EARNING------------------------------
    label_eanrning = Label(frame_work, text="Stipendio:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_eanrning.grid(row=4, column=2, pady=6, padx=3, sticky=W)

    entry_eanrning = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_eanrning.grid(row=4, column=3)
    # -----------------------------------------------------------
    # --------------------sedi-------------------------------
    label_occupation = Label(frame_work, text="Sedi:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                             bg="#5a5050", )
    ...
    send = Button(frame_work, text="Add", font=("SimHei", 12), width=10, fg="#a2d4ab", bg="#5a5050",
                  activeforeground="white",
                  activebackground="#5a5050",
...
def read_db():  # raad someones data from DB
    ...
    def dataFrom_readDB():
        ...
        db_data = Label(frame_work, text=data, font=("SimHei", 14, "normal"), fg="#a2d4ab")
    ...
    label_title = Label(frame_work, text="Cerca persone", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=5, pady=6, padx=3)
    ...
    send = Button(frame_work, text="Search", font=("SimHei", 12), width=10, fg="#a2d4ab", bg="#5a5050",
                  activeforeground="white",
                  activebackground="#5a5050",
...
def update():  # update someones data
    ...
    def seValueForm():
        ...
        for i in range(len(G)):
            radio_gender = Radiobutton(frame_work, text=G[i], value=i, variable=val, bg="#5a5050",
                                       activeforeground="white",
                                       activebackground="#5a5050", command=get_gender)
            if i == 0:
        ...
        # ----------------------EARNING------------------------------
        label_eanrning = Label(frame_work, text="Stipendio:", font=("SimHei", 14, "normal"), fg="#a2d4ab",
                               bg="#5a5050", )
        ...
        send = Button(frame_work, text="Update", font=("SimHei", 12), width=10, fg="#a2d4ab", bg="#5a5050",
                      activeforeground="white",
                      activebackground="#5a5050",
    ...
    label_title = Label(frame_work, text="Aggiorna persona", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=5, pady=6, padx=3)
    ...
    send = Button(frame_work, text="Search", font=("SimHei", 12), width=20, fg="#a2d4ab", bg="#5a5050",
                  activeforeground="white",
                  activebackground="#5a5050",
...
def delete():  # delete someone information from db
    ...
    def eliminate(info_totale):
        ...
        if messagebox.askokcancel(title="Are you sure", message="delete user: "+info_totale[1]+" "+info_totale[2]+"  " ):
            ...
            mess = Label(frame_work, text="user "+info_totale[1]+" "+info_totale[2]+" deleted",
                         font=("SimHei", 14, "normal"), fg="#a2d4ab",width=40)
    ...
    label_title = Label(frame_work, text="Delete user from database", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=5, pady=6, padx=3)
    ...
    send = Button(frame_work, text="Delete", font=("SimHei", 12), width=10, fg="#a2d4ab", bg="#5a5050",
                  activeforeground="white",
                  activebackground="#5a5050",
                  pady=10,
                  command=get_search)
...
def add_Impieghi():
    ...
    label_title = Label(frame_work, text="Add Impiego", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=2, pady=6, padx=6)

    # ------------------------NAME---------------------------
    label_name = Label(frame_work, text="Nuovo Impiego:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_name.grid(row=1, column=0, pady=6, padx=3, sticky=W)

    entry_impiego = Entry(frame_work, font=("SimHei", 15), width=15, )
...
def add_Sedi():
    ...
    label_title = Label(frame_work, text="Nuovo Sede", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=2, pady=6, padx=6)

    # ------------------------Indirizzo---------------------------
    label_indirizzo = Label(frame_work, text="Indirizzo:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_indirizzo.grid(row=1, column=0, pady=6, padx=3, sticky=W)

    entry_indirizzo = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_indirizzo.grid(row=1, column=1)
    # -----------------------------------------------------------
    # ------------------------Citta---------------------------
    label_citta = Label(frame_work, text="Citta:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_citta.grid(row=2, column=0, pady=6, padx=3, sticky=W)

    entry_citta = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_citta.grid(row=2, column=1)
    # -----------------------------------------------------------
    # ------------------------Provincia---------------------------
    label_provincia = Label(frame_work, text="Provincia:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_provincia.grid(row=3, column=0, pady=6, padx=3, sticky=W)

    entry_provincia = Entry(frame_work, font=("SimHei", 15), width=15, )
    entry_provincia.grid(row=3, column=1)
    # -----------------------------------------------------------
    # ------------------------CAP--------------------------
    label_cap = Label(frame_work, text="Cap:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_cap.grid(row=4, column=0, pady=6, padx=3, sticky=W)

    entry_cap = Entry(frame_work, font=("SimHei", 15), width=15, )
...
def add_Reparti():
    ...
    label_title = Label(frame_work, text="Nuovo Reparto", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=2, pady=6, padx=6)
    ...
    # -----------------------------------------------------------
    # ------------------------Nuovo reparto---------------------------
    label_reparto = Label(frame_work, text="Nuovo Reparto:", font=("SimHei", 14, "normal"), fg="#a2d4ab", bg="#5a5050", )
    label_reparto.grid(row=2, column=0, pady=6, padx=3, sticky=W)

    entry_reparto = Entry(frame_work, font=("SimHei", 15), width=23)
...
def get_dipendenti():
    ...
    Window_create = Tk()
    Window_create.title(text)
    Window_create.geometry("410x550")
    Window_create.config(background="#5a5050")
    #-----------------------------------SCROLLBAR---------

    scrollBar_frame=Frame(Window_create)
    scrollBar_frame.pack(fill=BOTH,expand=1)

    my_canvas=Canvas(scrollBar_frame)
    my_canvas.pack(side=LEFT,fill=BOTH,expand=1)

    my_bar=Scrollbar(scrollBar_frame,orient=VERTICAL,command=my_canvas.yview)
    my_bar.pack(side=RIGHT,fill=Y)

    my_canvas.configure(yscrollcommand=my_bar.set)
    my_canvas.bind("<Configure>",lambda e : my_canvas.configure(scrollregion=my_canvas.bbox("all")))

    frame_work = Frame(my_canvas, bg="#5a5050")
    frame_work.pack(pady=50)

    my_canvas.create_window((0,0),window=frame_work,anchor="nw")
    #---------------------------------------------------


    label_title = Label(frame_work, text="Tutti i Dipendenti", font=("SimHei", 20, "bold"), fg="#a2d4ab", bg="#5a5050")
    label_title.grid(row=0, columnspan=2, pady=6, padx=6)
    ...
    for i in tutti_dipendenti:
        ...
        db_data = Label(frame_work, text=data, font=("SimHei", 14, "normal"), fg="#a2d4ab",bg="#5a5050",width=35)
