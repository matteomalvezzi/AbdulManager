...
from Python_project.src import Client_prog as cl

#////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

def authentication(user,passw,window):
    if user == "Admin" or user == "admin":
        if passw == "qwerty":
            ...
            messagebox.showerror("Application", "Password Errata")  # launch popup error
    else:
        messagebox.showerror("Application", "UserName Errata")
...
def create():#add someone to the db
    ...
    # -----------------------------------------------------------
    # --------------------OCCUPATION-----------------------------
    label_occupation = Label(frame_work, text="Occupazione:", font=("Arial", 14, "normal"), fg="#edb415", bg="#801d2b", )
    ...
    send=Button(frame_work,text="Add",font=("Arial", 12),width=10,fg="#edb415",bg="#801d2b",activeforeground="white",
                        activebackground="#801d2b",
                        pady=10,)
